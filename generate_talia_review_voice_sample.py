...
OUTPUT_DIR = ROOT / "output" / "narration_samples" / "talia"
RAW_PATH = OUTPUT_DIR / "talia_review_sample.raw.mp3"
FINAL_PATH = OUTPUT_DIR / "talia_review_sample.mp3"
MANIFEST_PATH = OUTPUT_DIR / "talia_review_sample.json"

VOICE_NAME = "Talia - Warm Soft Guide"
VOICE_ID = "OZ0L6eISlOejga3XjDFt"
MODEL_ID = "eleven_v3"
TEXT = "The doors are sealed, and something inside is already hunting them."
...
def main() -> int:
    ...
    manifest = {
        ...
        "voice_id": VOICE_ID,
        "model": MODEL_ID,
        "delivery": "warm, soft, clear, compact movie-review narration",
        "settings": {
            "stability": 0.6,
            "similarity_boost": 0.75,
            "style": 0.0,
