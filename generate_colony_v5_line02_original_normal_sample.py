...
RAW_PATH = OUTPUT_DIR / "colony_v5_line_02_original_normal.raw.mp3"
FINAL_PATH = OUTPUT_DIR / "colony_v5_line_02_original_normal.mp3"
MANIFEST_PATH = OUTPUT_DIR / "colony_v5_line_02_original_normal.json"

VOICE_ID = "Vuo6zmtjWmlDbzqgIDos"
MODEL_ID = "eleven_v3"
TEXT = "This ordinary gathering is about to become a human experiment."
CAPTION_KO = "평범한 모임이 곧 실험장으로 변합니다."
...
def main() -> int:
    ...
    manifest = {
        ...
        "model": MODEL_ID,
        "text": TEXT,
        "korean_caption": CAPTION_KO,
        "settings": "voice defaults (no request override)",
        "post_processing": "same as approved original-normal sample",
